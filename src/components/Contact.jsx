...
export default function Contact() {
  ...
  return (
    <section id="contact" className="bg-coal-900 py-24 lg:py-32 relative overflow-hidden">
      {/* Background stripe */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div ref={refL}>
            ...
            {/* Contact details */}
            <div className={`anim-up ${visL ? 'anim-show' : ''} mt-10 space-y-5`}
              ...
              <InfoRow icon={
                ...
                <a href={`tel:${t('contact.phone')}`} className="hover:text-primary-500 transition-colors">
                  {t('contact.phone')}
                </a>
              </InfoRow>
              ...
              <InfoRow icon={
                ...
                <a href={`mailto:${t('contact.email')}`} className="hover:text-primary-500 transition-colors">
                  {t('contact.email')}
                </a>
              </InfoRow>
            ...
            {/* Map placeholder */}
            <div className={`anim-up ${visL ? 'anim-show' : ''} mt-8`}
                 style={{ transitionDelay: visL ? '280ms' : '0ms' }}>
              <div className="aspect-[16/9] bg-coal-700 border border-coal-600 flex flex-col
                              items-center justify-center gap-2">
                <svg className="w-8 h-8 text-coal-400" fill="none" viewBox="0 0 24 24"
                     stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round"
                    d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" />
                </svg>
                <p className="font-display font-bold text-[11px] tracking-[0.2em] text-coal-300 uppercase">
                  MAP PLACEHOLDER
                </p>
                <p className="font-sans text-coal-400 text-xs">Embed Google Maps di sini</p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            {submitted ? (
              <div className="flex flex-col items-center justify-center text-center py-12 h-full">
                <div className="w-16 h-16 bg-primary-500/10 border border-primary-500/40 flex items-center
              ...
              <form onSubmit={handleSubmit} className="space-y-5" noValidate>
                ...
                <div className="grid sm:grid-cols-2 gap-5">
                  {['name','email'].map(field => (
                    <div key={field}>
                      <label className="block font-display font-bold text-[10px] tracking-[0.2em]
                ...
                <button type="submit" className="btn-yellow w-full justify-center mt-2">
                  {cf.submit}
